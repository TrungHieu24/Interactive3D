...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 px-8 md:px-12 py-6 flex items-start justify-between pointer-events-none">
      {/* Logo + X-Ray toggle (trái) */}
      <div className="flex flex-col gap-4 pointer-events-auto">
        <div className="leading-none">
          <div className="text-white text-sm font-bold tracking-[0.25em]">
            VINFAST
          </div>
          <div className="text-[10px] text-cyan-300/70 tracking-[0.3em] mt-1">
            X-RAY CONCEPT
          </div>
        </div>
        ...
        <button
          ...
          className="
            ...
            px-4 py-2 text-[11px] tracking-[0.2em] text-white/80
      ...
      <div className="pointer-events-auto text-white/50 text-[11px] tracking-[0.15em] whitespace-nowrap">
        IMMERSIVE BY{" "}
        <span className="text-white/80 font-semibold">pathtech</span>
      </div>
    </header>
  );
}